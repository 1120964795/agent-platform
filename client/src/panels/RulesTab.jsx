    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-[color:var(--text-muted)]">Agent 会长期记住的偏好会保存在这里。</p>
        </div>
        <div className="flex gap-2">
          <button type="button" onClick={load} className="h-8 rounded-md border border-[color:var(--border)] px-2 text-xs hover:bg-[color:var(--bg-tertiary)] flex items-center gap-1"><RefreshCw size={13} className={loading ? 'animate-spin' : ''} /> 刷新</button>
